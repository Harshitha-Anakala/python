...
# Game variables
snake = Tile(TILE_SIZE * 5, TILE_SIZE * 5)  # Snake head
food = Tile(TILE_SIZE * 10, TILE_SIZE * 10)  # Food
velocityX = 0
velocityY = 0
snake_body = []
game_over = False
